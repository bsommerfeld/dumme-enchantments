...
import static gg.norisk.enchantments.impl.boomerang.AxeThrowAttachments.THROWN_AXE_ITEM_STACK;
import static gg.norisk.enchantments.impl.boomerang.AxeThrowAttachments.THROWN_AXE_TICKS_ACTIVE;
...
public class ThrownAxeEntity extends TridentEntity {
    ...
    public static @NotNull ThrownAxeEntity fromOwnerAndItemStack(World world, LivingEntity owner, ItemStack stack, int slot) {
        ...
        System.out.println("###Item V2 " + stack);
