...
object EnchantmentRegistry {
    ...
    val boomerang: RegistryKey<Enchantment> = of("boomerang")
    val stumble: RegistryKey<Enchantment> = of("stumble")
    val antiknockback: RegistryKey<Enchantment> = of("antiknockback")
